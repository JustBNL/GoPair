...
public class UserContextHolder {
    ...
    /**
     * MDC键常量 (使用 MessageConstants 统一管理)
     */
    private static final String MDC_USER_ID = MessageConstants.MDC_USER_ID;
    private static final String MDC_NICKNAME = MessageConstants.MDC_NICKNAME;
