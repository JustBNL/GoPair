...
export const ERROR_CODES = {
  ...
  // 管理员服务错误 (20000-20099)
  ADMIN_NOT_FOUND: 20000,
  ADMIN_DISABLED: 20001,
  ADMIN_PASSWORD_ERROR: 20002,
  USER_NOT_FOUND: 20003,
  ROOM_NOT_FOUND: 20004,
  FILE_NOT_FOUND: 20005,
  VOICE_CALL_NOT_FOUND: 20006,
  EMAIL_ALREADY_USED: 20007
} as const
...
export const ERROR_MESSAGES: Record<number, string> = {
  ...
  // 管理员服务错误消息
  [ERROR_CODES.ADMIN_NOT_FOUND]: '管理员账号不存在',
  [ERROR_CODES.ADMIN_DISABLED]: '管理员账号已被停用',
  [ERROR_CODES.ADMIN_PASSWORD_ERROR]: '密码错误',
  [ERROR_CODES.USER_NOT_FOUND]: '用户不存在',
  [ERROR_CODES.ROOM_NOT_FOUND]: '房间不存在',
  [ERROR_CODES.FILE_NOT_FOUND]: '文件记录不存在',
  [ERROR_CODES.VOICE_CALL_NOT_FOUND]: '通话记录不存在',
  [ERROR_CODES.EMAIL_ALREADY_USED]: '该邮箱已被其他用户使用'
}
